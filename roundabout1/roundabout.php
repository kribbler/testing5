...
mysql_query("CREATE TABLE IF NOT EXISTS `wp_roundabout` (
...
mysql_query("CREATE TABLE IF NOT EXISTS `wp_roundabout_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(5000) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5");

mysql_query("CREATE TABLE IF NOT EXISTS `wp_roundabout_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
mysql_query("ALTER TABLE `wp_roundabout` ADD `order` INT NOT NULL");

mysql_query("ALTER TABLE `wp_roundabout_settings` ADD `opacity` varchar(5000) DEFAULT '0.5'");
